...
export class XR extends System {
  ...
  async enter() {
    ...
    this.controller1Model =
      this.world.graphics.renderer.xr.getControllerGrip(0);
    this.controller1Model.add(
      this.controllerModelFactory.createControllerModel(this.controller1Model)
    );
    this.world.rig.add(this.controller1Model);

    this.controller2Model =
      this.world.graphics.renderer.xr.getControllerGrip(1);
    this.controller2Model.add(
      this.controllerModelFactory.createControllerModel(this.controller2Model)
    );
