...
export class UIImage extends Node {
  ...
  mount() {
    ...
    this.parent.yogaNode.insertChild(
      this.yogaNode,
      this.parent.yogaNode.getChildCount()
    );
  ...
  set absolute(value = defaults.absolute) {
    ...
    this.yogaNode?.setPositionType(
      this._absolute
        ? Yoga.POSITION_TYPE_ABSOLUTE.ABSOLUTE
  ...
  set top(value = defaults.top) {
    ...
    this.yogaNode?.setPosition(
      Yoga.EDGE_TOP,
      isNum ? this._top * this.ui._res : undefined
    );
    this.ui?.redraw();
  }
  ...
  set right(value = defaults.right) {
    ...
    this.yogaNode?.setPosition(
      Yoga.EDGE_RIGHT,
      isNum ? this._right * this.ui._res : undefined
    );
    this.ui?.redraw();
  }
  ...
  set bottom(value = defaults.bottom) {
    ...
    this.yogaNode?.setPosition(
      Yoga.EDGE_BOTTOM,
      isNum ? this._bottom * this.ui._res : undefined
    );
    this.ui?.redraw();
  }
  ...
  set left(value = defaults.left) {
    ...
    this.yogaNode?.setPosition(
      Yoga.EDGE_LEFT,
      isNum ? this._left * this.ui._res : undefined
    );
    this.ui?.redraw();
  }
