    ...
    const p = i.__csm.prevOnBeforeCompile,
      t = (a, o, _) => {
        ...
        if (o) {
          const l =
            /void\s+main\s*\(\s*\)[^{]*{((?:[^{}]+|{(?:[^{}]+|{(?:[^{}]+|{(?:[^{}]+|{[^{}]*})*})*})*})*})/gm;
          (s = (c = o.matchAll(l).next().value) == null ? void 0 : c[1]),
            s && (s = s.slice(0, -1));
...
` +
        ...
        if (c === "*" || (r && r.includes(c)) || l) {
          ...
          for (const g in C) {
            ...
            if (typeof A == "object") {
              ...
              A &&
                ((a.vertexShader = a.vertexShader.replace(g, A)),
                (a.fragmentShader = a.fragmentShader.replace(g, A)));
          }
        }
      }
    ...
    (i.customProgramCacheKey = () =>
      ((m == null ? void 0 : m()) || U((f || "") + (r || ""))) +
      (E == null ? void 0 : E.call(i))),
      (i.needsUpdate = !0);
  }
}
